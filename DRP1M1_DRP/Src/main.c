...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  LL_ADC_REG_SetSequencerChAdd(ADC1, LL_ADC_CHANNEL_0|LL_ADC_CHANNEL_15);
...
void MX_UCPD1_Init(void)
{
  ...
  */
  ...
  /* UCPD1_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_CHANNEL_5, LL_DMAMUX_REQ_UCPD1_RX);
...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(VCC_PIN_GPIO_Port, VCC_PIN_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(VCC_PIN_GPIO_Port, &GPIO_InitStruct);
